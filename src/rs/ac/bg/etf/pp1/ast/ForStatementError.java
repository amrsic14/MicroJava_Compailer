...
public class ForStatementError extends Statement {
    ...
    public ForStatementError (OptDesigStatement OptDesigStatement, ForFirstSemi ForFirstSemi, OptDesigStatement OptDesigStatement1, ForParenEnd ForParenEnd, Statement Statement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ForStatementError(\n");
