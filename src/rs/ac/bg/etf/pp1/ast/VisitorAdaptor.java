...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(AssignMulopRight AssignMulopRight) { visit(); }
    ...
    public void visit(RightMulop RightMulop) { visit(); }
    public void visit(LeftMulop LeftMulop) { visit(); }
    ...
    public void visit(FactorParenths FactorParenths) { visit(); }
    ...
    public void visit(FactorDesignatorNoActs FactorDesignatorNoActs) { visit(); }
    public void visit(FactorDesignatorHasActs FactorDesignatorHasActs) { visit(); }
    public void visit(FactorTermSingle FactorTermSingle) { visit(); }
    public void visit(TermMulopFactor TermMulopFactor) { visit(); }
    public void visit(TermMinus TermMinus) { visit(); }
    public void visit(TermPlus TermPlus) { visit(); }
    public void visit(TermsList TermsList) { visit(); }
    ...
    public void visit(DesigOptActLeftParen DesigOptActLeftParen) { visit(); }
    public void visit(OptionalActualsDesigStatement OptionalActualsDesigStatement) { visit(); }
    public void visit(DecDesigStatement DecDesigStatement) { visit(); }
    public void visit(IncDesigStatement IncDesigStatement) { visit(); }
    public void visit(AssignopDesigStatementError AssignopDesigStatementError) { visit(); }
    public void visit(AssignopDesigStatement AssignopDesigStatement) { visit(); }
    ...
    public void visit(PrintConstStatement PrintConstStatement) { visit(); }
