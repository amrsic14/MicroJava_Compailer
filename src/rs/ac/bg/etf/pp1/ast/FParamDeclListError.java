...
public class FParamDeclListError extends FParamDeclList {

    private FParamDeclaration FParamDeclaration;

    public FParamDeclListError (FParamDeclaration FParamDeclaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FParamDeclListError(\n");
