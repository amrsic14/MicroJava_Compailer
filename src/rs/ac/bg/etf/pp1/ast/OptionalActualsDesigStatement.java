...
public class OptionalActualsDesigStatement extends DesignatorStatement {

    private Designator Designator;
    private DesigOptActLeftParen DesigOptActLeftParen;
    private OptActualParams OptActualParams;

    public OptionalActualsDesigStatement (Designator Designator, DesigOptActLeftParen DesigOptActLeftParen, OptActualParams OptActualParams) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("OptionalActualsDesigStatement(\n");
